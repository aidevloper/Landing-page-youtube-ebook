...
export const CASHFREE_CONFIG = {
  ...
  app_id: import.meta.env.VITE_CASHFREE_APP_ID || 'YOUR_CASHFREE_APP_ID',

  // Get Secret Key for payment verification
  secret_key: import.meta.env.CASHFREE_SECRET_KEY || 'YOUR_CASHFREE_SECRET_KEY',
...
export const validateCashfreeConfig = () => {
  ...
  if (!appId || appId === 'TEST_APP_ID' || appId === 'YOUR_CASHFREE_APP_ID') {
