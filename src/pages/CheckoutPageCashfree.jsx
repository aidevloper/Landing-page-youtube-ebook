    ...
    try {
      ...
      if (realValidation.valid) {
        ...
        const usePopup = confirm(
          ...
          'OK = Open payment form in new window (recommended)\n' +
          'Cancel = Redirect to payment form'
        );
        ...
        const usePopup = confirm(
          'Demo Mode Active\n\n' +
          'Real Cashfree credentials not configured.\n' +
          'This will simulate the payment process for testing.\n\n' +
          'OK = Open demo payment in new window\n' +
          'Cancel = Use inline demo payment'
        );
